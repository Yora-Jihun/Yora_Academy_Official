        ...
        <div class="bg-white rounded-none p-6 w-96">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="button" wire:click="createSection" wire:loading.attr="disabled" wire:target="createSection" class="px-4 py-2 text-white bg-[#5B5FEF] rounded-none hover:bg-[#4A4DDF] disabled:opacity-70 disabled:cursor-not-allowed">Create</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-none p-6 w-96">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button type="button" wire:click="createPage" wire:loading.attr="disabled" wire:target="createPage" class="px-4 py-2 text-white bg-[#5B5FEF] rounded-none hover:bg-[#4A4DDF] disabled:opacity-70 disabled:cursor-not-allowed">Create</button>
                </div>
            </div>
        </div>
    </div>
