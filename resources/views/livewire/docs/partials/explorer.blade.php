                ...
                @foreach($doc->sections as $section)
                    <div class="space-y-0.5 mt-1 md:mt-1.5">
                        <div class="flex items-center gap-2 px-2 md:px-3 py-1.5 md:py-2 text-xs md:text-[14px] text-gray-800 rounded-none">
                            <button type="button" wire:click="toggleSection({{ $section->id }})" data-context-type="section" data-context-id="{{ $section->id }}" class="flex items-center gap-2 flex-1 text-left">
