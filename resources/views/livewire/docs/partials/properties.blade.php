        ...
        <div class="px-3 md:px-4 py-3 md:py-4 space-y-3 md:space-y-4 flex-1">
            ...
            <div>
                <div class="flex items-center gap-2 md:gap-3">
                    <img src="{{ $doc?->user?->avatar ? \Illuminate\Support\Facades\Storage::disk('avatars')->url($doc->user->avatar) : asset('assets/images/Jerome_Edica.jpg') }}" class="w-7 h-7 md:w-8 md:h-8 rounded-full" alt="Author">
                    <div>
