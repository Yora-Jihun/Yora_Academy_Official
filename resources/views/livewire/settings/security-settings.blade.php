<div class="space-y-6">
    ...
    <div class="bg-white border border-gray-100 p-6">
        ...
        <form wire:submit="submit" class="space-y-4 max-w-md">
            ...
            <div class="pt-2">
                <button type="submit" class="px-5 py-2.5 bg-[#5B5FEF] text-white text-sm font-medium rounded-none hover:bg-[#4A4DDF] focus:outline-none focus:ring-4 focus:ring-[#5B5FEF]/20 transition">Update Password</button>
            </div>
        </form>
    </div>
