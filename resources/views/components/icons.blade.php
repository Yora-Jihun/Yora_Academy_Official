<svg {{ $attributes->merge(['class' => 'w-5 h-5', 'xmlns' => 'http://www.w3.org/2000/svg', 'fill' => 'none', 'viewBox' => '0 0 24 24', 'stroke-width' => '2', 'stroke' => 'currentColor']) }}>
    @switch($icon)
        ...
        @case('settings')
            ...
            @break
        @case('logout')
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5.75h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M15 12l3 3m0 0l-3 3m3-3H9"/>
            @break
        @case('search')
