            ...
            <div class="text-center lg:text-left space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                    <a
                        href="{{ route('login') }}"
                        wire:navigate
                        class="inline-flex items-center justify-center bg-[#0A5FFF] px-8 py-3.5 text-sm font-semibold text-white rounded-none transition duration-200 hover:bg-[#0757E8] hover:shadow-lg hover:shadow-blue-600/20 focus:outline-none focus:ring-4 focus:ring-blue-500/20"
                    >
                        Sign in
                    </a>
                    <a
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-white rounded-none border border-slate-100 shadow-xl shadow-slate-200/50 p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="h-16 rounded-none bg-blue-50 border border-blue-100"></div>
                            <div class="h-16 rounded-none bg-slate-50 border border-slate-100"></div>
                        </div>
                        <div class="h-10 rounded-none bg-blue-200 w-1/3"></div>
                    </div>
                </div>
            </div>
        </div>
